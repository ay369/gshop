...
export const RESULT_USER_INFO = 'result_user_info'; // 接收用户信息

export const RECEIVE_GOODS = 'receive_goods'; // 接收商品数组
export const RECEIVE_RATINGS = 'receive_ratings'; // 接收商品评价数组
export const RECEIVE_INFO = 'receive_info'; // 接收商家信息

export const INCREMENT_FOOD_COUNT = 'increment_food_count'; // 增加food中的值
export const DECREMENT_FOOD_COUNT = 'decrement_food_count'; // 减少food中的值
